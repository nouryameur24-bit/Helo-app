...
// Audit fix #8 : limite 12mb. Le défaut Express (100kb) REJETAIT les photos
// base64 ~8mb de /analyze-ingredients-image (Claude Vision = LE MOAT) → 413
// silencieux en prod. Vision + ocr-cleanup ont besoin d'un body large.
